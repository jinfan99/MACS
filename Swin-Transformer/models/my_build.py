...
from .conv_swin_transformer import ConvSwinTransformer


def build_model(config):
    model_type = config.MODEL.TYPE
    if model_type == 'swin':
        model = ConvSwinTransformer(img_size=config.DATA.IMG_SIZE,
        ...
        # freeze the layers
        # frozen_layers = ['patch_embed.', 'layers.0', 'layers.1', 'layers.2']
